...
export default function CoachTutorials() {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            You need to be registered as a coach to upload tutorials.
          </p>
        </div>
      </div>
    );
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{tutorials.filter(t => t.is_published).length}</p>
            </div>
          </div>
        </div>
